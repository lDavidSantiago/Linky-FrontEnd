        ...
        <div className="mx-auto w-full max-w-[300px]">
          <div className="relative">
            <input
              type="text"
              ref={inputRef}
              /*Aqui es el valor para cambiar lo que se puede copiar */
              value="placeholder"
              className="h-12 w-full rounded-lg border border-stroke bg-transparent py-3 pl-5 pr-14 text-dark outline-none duration-200 selection:bg-transparent focus:border-primary dark:border-dark-3 dark:text-white"
            />
            <button
